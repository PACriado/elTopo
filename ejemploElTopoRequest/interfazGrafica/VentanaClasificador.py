...
class VentanaClasificador():
    def __init__(self):
        ...
        self.BTN_Abrirdir = ttk.Button(self.ventana, text="Clasificar Directorio", command=self.ruta_text, width=30)
        self.BTN_Header = ttk.Button(self.ventana, text="Clasificar Headers", command=self.classificator_header_directory)
        self.BTN_Url = ttk.Button(self.ventana, text="Clasificar Url", command=self.classificator_url_directory)
        self.BTN_Paragraph = ttk.Button(self.ventana, text="Clasificar Parrafos",
                                        command=self.classificator_paragraph_directory)
        self.BTN_Metadata = ttk.Button(self.ventana, text="Clasificar Metadatos", command=self.classificator_metadata_directory)
        self.BTN_Span = ttk.Button(self.ventana, text="Clasificar Spans", command=self.classificator_span_directory)
        self.BTN_Title = ttk.Button(self.ventana, text="Clasificar Titulo", command=self.classificator_title_directory)
        self.BTN_All = ttk.Button(self.ventana, text="Clasificar Todos Los Datos", command=self.classificator_alldata_directory)
        self.url = ttk.Entry(self.ventana, width=80)
        self.BTN_VerUltimosResultados = ttk.Button(self.ventana, text="Ver grafico ultimos resultados",
                                                   command=self.mostrarVentanaDatos)

        self.BTN_Abrirfich = ttk.Button(self.ventana, text="Clasificar Fichero", command=self.ruta_textfich, width=30)
        self.BTN_Headerfich = ttk.Button(self.ventana, text="Clasificar Headers", command=self.classificator_header)
        self.BTN_Urlfich = ttk.Button(self.ventana, text="Clasificar Url", command=self.classificator_url)
        self.BTN_Paragraphfich = ttk.Button(self.ventana, text="Clasificar Parrafos", command=self.classificator_paragraph)
        self.BTN_Metadatafich = ttk.Button(self.ventana, text="Clasificar Metadatos", command=self.classificator_metadata)
        self.BTN_Spanfich = ttk.Button(self.ventana, text="Clasificar Spans", command=self.classificator_span)
        self.BTN_Titlefich = ttk.Button(self.ventana, text="Clasificar Titulo", command=self.classificator_title)
        self.BTN_Allfich = ttk.Button(self.ventana, text="Clasificar Todos Los Datos", command=self.classificator_alldata)
    ...
    def classificator_header(self):
        ...
        estadisticasResultado = clasificator.accuracyAllByCategory("HEADER",
                                                                   self.configuracion.getRutaFicheroCategorias(),
    ...
    def classificator_alldata(self):
        ...
        # print(clasificator.classifyAllUrl())
        # print(clasificator.accuracyAll("URL", "Armas"))
        estadisticasResultado = clasificator.accuracyAllByCategory("PARRAFO",
                                                                   self.configuracion.getRutaFicheroCategorias(),
                                                                   URL=webPageInfoObject.getUrl())
        print("Clasificada la URL {0} ".format(webPageInfoObject.getUrl()))
        self.estadisticasResultado.append(estadisticasResultado)
    ...
    def classificator_metadata(self):
        ...
        estadisticasResultado = clasificator.accuracyAllByCategory("META",
                                                                   self.configuracion.getRutaFicheroCategorias(),
                                                                   URL=webPageInfoObject.getUrl())
        print("Clasificada la URL {0} ".format(webPageInfoObject.getUrl()))
        self.estadisticasResultado.append(estadisticasResultado)
    ...
    def classificator_span(self):
        ...
        estadisticasResultado = clasificator.accuracyAllByCategory("SPAN",
                                                                   self.configuracion.getRutaFicheroCategorias(),
                                                                   URL=webPageInfoObject.getUrl())
        print("Clasificada la URL {0} ".format(webPageInfoObject.getUrl()))
        self.estadisticasResultado.append(estadisticasResultado)
    ...
    def classificator_title(self):
        ...
        estadisticasResultado = clasificator.accuracyAllByCategory("TITLE",
                                                                   self.configuracion.getRutaFicheroCategorias(),
                                                                   URL=webPageInfoObject.getUrl())
        print("Clasificada la URL {0} ".format(webPageInfoObject.getUrl()))
        self.estadisticasResultado.append(estadisticasResultado)
    ...
    def classificator_url_directory(self):
        ...
        for webPageInfoObject in allObjects:
            ...
            # print(clasificator.classifyAllUrl())
            # print(clasificator.accuracyAll("URL", "Armas"))
            estadisticasResultado = clasificator.accuracyAllByCategory("URL",
                                                                       self.configuracion.getRutaFicheroCategorias(),
                                                                       URL=webPageInfoObject.getUrl())
            print("Clasificada la URL {0} ".format(webPageInfoObject.getUrl()))
            self.estadisticasResultado.append(estadisticasResultado)
